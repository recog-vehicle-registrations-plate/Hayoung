...
def make_aug(classifier, current_num):
    ...
    for i in range(1):
        ...
        for j in range(len(file_list)):
            ...
            for batch in datagen.flow(x, batch_size=1, save_to_dir='/home/pirl/LP_detection_model/data_aug_result/%s'%classifier, save_prefix='%s'%classifier, save_format='jpeg'):
                k += 1
