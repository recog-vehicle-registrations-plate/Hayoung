...
#
#
# def resize_one_line_img(input_img):
#     height = 40
#     width = 100
#     dim = (width, height)
#     resized_image = cv2.resize(input_img, dim, interpolation=cv2.INTER_AREA)
...
#
#
# def resize_two_line_img(input_img):
#     height = math.floor(80*(2/3))
#     width = math.floor(100*(2/3))
#     dim = (width, height)
#     resized_image = cv2.resize(input_img, dim, interpolation=cv2.INTER_AREA)
#     height, width, channel = input_img.shape
#     # print('Resized Dimensions : ', resized_image.shape)
...
#     contours, hierarchy = cv2.findContours(input_image, cv2.RETR_LIST, cv2.CHAIN_APPROX_SIMPLE)
#
#     return contours
#
#
# def find_rectangle(input_contours):
#     contours_dict = []
#
...
#
#
# def filter_rectangle(contours_dict):
#     MIN_AREA = 200
#     MAX_AREA = 2000
#     # MIN_WIDTH, MIN_HEIGHT = 2, 8
#     MIN_RATIO, MAX_RATIO = 1.0, 2.0
...
#
#
# def find_lp_rectangle(possible_contours):
#     MAX_DIAG_MULTIPLYER = 5  # 5
#     MAX_ANGLE_DIFF = 50.0  # 12.0
#     MAX_AREA_DIFF = 3  # 0.5
#     MAX_WIDTH_DIFF = 2
...
#
#
# def rotate_image(original_image, matched_result):
